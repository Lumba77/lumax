...
static var _processed_this_session = null

static func is_processed(path: String) -> bool:
	if _processed_this_session == null:
		_processed_this_session = {}
	return _processed_this_session.has(path)

static func mark_processed(path: String):
	if _processed_this_session == null:
		_processed_this_session = {}
	_processed_this_session[path] = true
